...
<body>
    <header>
        ...
        <section class="textos-header">
            <h2 class="animate__animated animate__fadeInDown">— Poductos Candy Craze —</h2>
            <h1 class="animate__animated animate__fadeInUp">Disfruta de nuestra gran variedad de dulces</h1>
        </section>
